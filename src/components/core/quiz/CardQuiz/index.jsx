             ...
             (
                ...
                <div className="">
                    <div className="  flex justify-between  px-11 w-10/12 mx-auto rounded-lg bg-gray-200 py-6">
                          ...
                          <button onClick={handleStartQuiz} disabled={loading} className=' rounded-md bg-blue-500 max-h-max py-1 px-4 flex justify-center items-center'>Start Quiz!</button>
