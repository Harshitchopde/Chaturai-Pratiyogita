  ...
  return (
    <div className=' fixed backdrop-blur-sm backdrop:blur-xl inset-0 z-[100] !mt-0 grid place-items-center 
     overflow-auto bg-opacity-10'>
        <div className=" w-11/12 max-w-[350px] rounded-lg border border-slate-700  bg-slate-200 font-semibold
        ">
            ...
            <div className="flex items-center gap-x-4">
                <IconBtn onClick={modelData?.btn1Handler}
                 ...
                 <button className=' cursor-pointer rounded-md py-[8px] px-[20px] font-semibold
